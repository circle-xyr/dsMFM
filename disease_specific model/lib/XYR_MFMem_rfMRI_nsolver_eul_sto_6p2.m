function [FC_simR, CC_check,FC_sim,FCD,metastable_sim,synchrony_sim] = XYR_MFMem_rfMRI_nsolver_eul_sto_6p2(parameter,prior,SC,y_FC,FC_mask,Nstate,Tepochlong,TBOLD,ifRepara,Myelin,atrophy,window)
...
FCD = XYR_CBIG_pMFM_step2_generate_FCD_desikan(BOLD_d,window);

CC_check = corr(atanh(FC_simR),atanh(y_FC));
[metastable_sim,synchrony_sim] = BOLD_metastable(BOLD_d);
